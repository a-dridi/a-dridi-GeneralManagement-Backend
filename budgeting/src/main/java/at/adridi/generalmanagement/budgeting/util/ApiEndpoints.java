 ...
 */
package at.adridi.generalmanagement.budgeting.util;

/**
 *
 * All REST API end point paths
 *
 * @author A.Dridi
 */
public class ApiEndpoints {

    public static final String API_RESTRICTED_DATABASE_EXPENSE = "/data/expense";
    public static final String API_RESTRICTED_DATABASE_EXPENSECATEGORY = "/data/expensecategory";
    public static final String API_RESTRICTED_DATABASE_EXPENSETIMERANGE = "/data/expensetimerange";
    public static final String API_RESTRICTED_DATABASE_EXPENSEBUDGET = "/data/expensebudget";
